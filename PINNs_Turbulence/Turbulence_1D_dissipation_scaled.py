...
class PhysicsInformedNN:
    ...
    def __init__(self, t, x, u,
        ...
        # loss
        self.loss = tf.reduce_sum(tf.square((self.u_tf - self.u_pred)/self.u_std)) + \
                    tf.reduce_sum(tf.square(self.eq_pred/self.u_std))
        
        self.loss_mean = tf.reduce_mean(tf.square((self.u_tf - self.u_pred)/self.u_std)) + \
                         tf.reduce_mean(tf.square(self.eq_pred/self.u_std))
